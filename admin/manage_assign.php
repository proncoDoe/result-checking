                ...
                <section id="breadcrumbs" class="breadcrumbs">
                    <div class="container">
                        ...
                        <ol>
                            ...
                            <li>Manage
                                assign subject|class</li>
                        </ol>
                        <h2>Manage
                            assign subject|class</h2>
                                    ...
                                    ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-2 mb-2">
                                            <div class="small"><a class="btn btn-dark"
                                                    href="./assign_subject.php">Manage
                                                    assign subject|class</a>
                                            </div>
                                        ...
                                        <div class="card-body text-white">
                                            ...
                                            $sql = "SELECT teacher.t_id,teacher.fullName,add_class.class_name,add_subject.subject,assign_subject.assign_id 
                                            as scid,assign_subject.status,assign_subject.created_at from assign_subject 
                                            join teacher on teacher.t_id=assign_subject.t_id
                                            join add_class on add_class.class_id=assign_subject.class_id  
                                             join add_subject on add_subject.subject_id=assign_subject.subject_id 
                                             GROUP BY teacher.fullName ORDER BY assign_subject.assign_id DESC";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 50%;text-align:left;">
                                                            ...
                                                            $classId = $result->t_id;
                                                                ...
                                                                join add_class on add_class.class_id=assign_subject.class_id 
                                                                 join add_subject on add_subject.subject_id=assign_subject.subject_id 
                                                                 WHERE teacher.t_id = '$classId' ORDER BY assign_subject.assign_id DESC";
                                                                ...
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    rel="tag"><?php echo $result->class_name; ?> <i
...
{ ?>
                                                            <a class="btn btn-outline-info" data-toggle='tooltip'
                                                                ...
                                                                href="manage_assign.php?app=<?php echo htmlentities($result->scid);?>"><i
                                                                    class="fa fa-check"></i>
                                                            </a><?php } else {?>

                                                            <a class="btn btn-outline-warning" data-toggle='tooltip'
                                                                data-placement='top' title='Subjects that are Approved'
                                                                href="manage_assign.php?unap=<?php echo htmlentities($result->scid);?>"><i
                                                                    class="fa fa-times"></i>
                                                            </a>
                                                            <?php }?>
                                                        ...
                                                        <td class='btn btn-group'>
                                                            ...
                                                            <a class="btn btn-outline-danger delete"
                                                                ...
                                                                title='Delete'
                                                                href="manage_assign.php?del=<?php echo htmlentities($result->t_id);?>"><i
                                                ...
                                                $app=intval($_GET['app']);
                                                $status="Approved";
                                                $sql="UPDATE `assign_subject` SET status=:status WHERE assign_id=:app ";
                                                $query = $conn->prepare($sql);
                                                ...
                                                $status="Unapproved";
                                                $sql="UPDATE `assign_subject` SET status=:status WHERE assign_id=:unap ";
                                                $query = $conn->prepare($sql);
                                                $query->bindParam(':status',$status,PDO::PARAM_STR);
                             ...
                             // for Deleting Subject
                                        ...
                                        {
                                        $del=intval($_GET['del']);
                                        $sql="DELETE FROM `assign_subject` WHERE t_id = :del ";
                                        $query = $conn->prepare($sql);
                                        ...
                                        $_SESSION['alert-class'] = "Subject|class assign Deleted";  
