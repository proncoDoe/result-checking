...
if(isset($_POST['addTeacher']))
{
    ...
    $t_image = $_FILES['t_image']['name'];
        ...
        //SQL query start
            $sql="INSERT INTO `teacher`(fullName,username,t_image,email,phoneNumber,status,roll,password,created_at) 
            VALUES(:fullName,:username,:image,:email,:phoneNumber,:status,:roll,:password,:created_at)";
        $query = $conn->prepare($sql);
        $query->bindParam(':fullName',$fullName,PDO::PARAM_STR);
        $query->bindParam(':image',$t_image,PDO::PARAM_STR);
        ...
        $_SESSION['alert-class'] = "Teacher crentials added";
                            ...
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="card-header"
                                            style="border-radius: 8px !important; background: linear-gradient(90deg, rgba(194, 63, 120, 1) 11%, rgba(177, 67, 126, 1) 50%, rgba(194, 63, 120, 1) 57%, rgba(72, 95, 167, 1)">
                                            <h3 class="text-center font-weight-light my-4 font-weight-bold">Create
                                                Teacher</h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="add_teacher.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit" name="addTeacher"
