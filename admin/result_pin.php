                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-2 mb-2">
                                            <div class="small"> <a href="javascript:void(0);" id="generate"
                                                    class="btn btn-primary" style="background: black;color: white;">
                                                    Add new Pin
                                                </a>
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if($stts=='Used')
                                                        {
                                                           ?>
                                                            ...
                                                            <button class="btn btn-danger"> <?php echo
                                                                htmlentities('Used Pin');?> </button>
                                                        ...
                                                        {
                                                            ?>
                                                            <button class="btn btn-outline-success"> <?php echo
                                                                htmlentities('New Pin'); ?> </button>
                                                            <?php
                                                        ...
                                                        <td class='btn btn-group'>
                                                            ...
                                                            <a class="btn btn-outline-danger delete"
                                                                ...
                                                                title='Delete'
                                                                href="result_pin.php?del=<?php echo htmlentities($result->id);?>"><i
                             ...
                             // for Deleting Subject
                                        ...
                                        {
                                        $del=intval($_GET['del']);
                                        $sql="DELETE FROM `result_pin` WHERE id = :del ";
                                        $query = $conn->prepare($sql);
                                        $query->bindParam(':del',$del,PDO::PARAM_STR);
                                        $query->execute();
                                    
                                        header('location: result_pin.php');
                                        $_SESSION['success'] = "successfully";
                                        $_SESSION['alert-class'] = "Pin Deleted";  
