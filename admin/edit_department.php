...
$subject = '';   
   ...
   $id = $_GET['edit_id'];
    ...
    $statement = 'SELECT * FROM `add_department` WHERE 	department_id  =  :id';
...
if(empty($department)){
   ...
   $_SESSION['alert-class'] = "Field is";
    ...
    $statement = 'UPDATE `add_department` SET department = :d_department,updated_at = :d_updated_at WHERE department_id = :id';
                                            ...
                                            <form action="edit_department.php" method="POST">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" name="department"
                                                        value="<?php echo $department; ?>" id="department" type="text"
