        ...
        <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-2 mb-2">
                                            <div class="small"><a class="btn btn-dark" href="./add_department.php">Add
                                                    Department</a>
                                            </div>
                            ...
                            $statement = 'SELECT * FROM `add_department`';
                              ...
                              ?>
                                                    <tr class="text-white font-weight-bold">
                                                        ...
                                                        <td class='btn btn-group'>
                                                            ...
                                                            <?php 
                                            echo "<a href='edit_department.php?edit_department&edit_id={$department_id}' data-toggle='tooltip' data-placement='top' title='Edit'
                                            ...
                                            echo "<a rel='$department_id' href='javascript:void(0)' data-toggle='tooltip'
                                ...
                                if(isset($_GET['delete'])){
                                    ...
                                    $statement = "DELETE FROM `add_department` WHERE `department_id` = :id";
            ...
            $(document).ready(function() {
                ...
                $(".delete_link").on('click', function() {
                    ...
                    let deleteUrl = "manage_department.php?delete=" + id + "";
