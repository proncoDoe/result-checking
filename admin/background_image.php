...
if (isset($_POST['UpdateBackground'])) {
    ...
    $target = "../assets/images/".basename($_FILES['backgroundImage']['name']);
    ...
    $sql = "UPDATE `settings` SET backgroundImage=:backgroundImage";
    $query= $conn->prepare($sql);
    $query->bindParam(':backgroundImage',$backgroundImage, PDO::PARAM_STR);
    $query->execute();
    
    if (move_uploaded_file($_FILES['backgroundImage']['tmp_name'], $target)) {
    $_SESSION['success'] = "change";
    $_SESSION['alert-class'] = "Background succesfully";
    }else{
                                        ...
                                        ?>
                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group" id="imagemi">
                                                    <label>
                                                        <img class="getpic"
                                                            src="../assets/images/<?php echo($backgroundImage); ?>"
                                                            ...
                                                            border-radius: 100px;">
                                                        <input type="file" name="backgroundImage" style="display: none;"
                                                ...
                                                <div class="d-flex align-items-center justify-content-center mt-4 mb-0">
                                                    <button type="submit" name="UpdateBackground"
