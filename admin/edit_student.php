...
$session = '';  
$phone_number = '';  
$how_would_like_to_be_contacted = '';  
$class_name = '';  
$student_image = ''; 
$register_no = ''; 
$dob = '';  
...
$card_serial_no = '';  
   ...
   $id = $_GET['stid'];
    ...
    $statement = 'SELECT * FROM `student` WHERE `student_id` =  :id';
    ...
    if($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        $how_would_like_to_be_contacted	 = $row['how_would_like_to_be_contacted'];
        $class_name = $row['class_name'];
        $student_image = $row['student_image'];
        $register_no = $row['register_no'];
        $username = $row['username'];
        $dob = $row['dob'];
        $exam_pin = $row['exam_pin'];
        $card_serial_no = $row['card_serial_no'];
...
$exam_pin=$_POST['exam_pin'];
$card_serial_no=$_POST['register_no'];
$updated_at = date('F, d y h:i:s');


if(empty($name) || empty($email) || empty($session) || empty($phone_number) 
|| empty($how_would_like_to_be_contacted) || empty($class_name) || empty($register_no) 
|| empty($dob) || empty($exam_pin) || empty($card_serial_no)){
    
    $_SESSION['danger'] = "required";
    $_SESSION['alert-class'] = "Filed is";
    
}else{

$sql="UPDATE `student` SET name=:name,email=:email,session=:session,phone_number=:phone_number,
how_would_like_to_be_contacted=:how_would_like_to_be_contacted,
class_name=:class_name,register_no=:register_no,username=:username,dob=:dob,exam_pin=:exam_pin,
card_serial_no=:card_serial_no,updated_at=:updated_at WHERE student_id=:id ";
$query = $conn->prepare($sql);
$query->bindParam(':name',$name,PDO::PARAM_STR);
$query->bindParam(':email',$email,PDO::PARAM_STR);
$query->bindParam(':session',$session,PDO::PARAM_STR);
$query->bindParam(':phone_number',$phone_number,PDO::PARAM_STR);
$query->bindParam(':how_would_like_to_be_contacted',$how_would_like_to_be_contacted,PDO::PARAM_STR);
$query->bindParam(':class_name',$class_name,PDO::PARAM_STR);
$query->bindParam(':register_no',$register_no,PDO::PARAM_STR);
$query->bindParam(':username',$username,PDO::PARAM_STR);
$query->bindParam(':dob',$dob,PDO::PARAM_STR);
$query->bindParam(':exam_pin',$exam_pin,PDO::PARAM_STR);
$query->bindParam(':card_serial_no',$card_serial_no,PDO::PARAM_STR);
...
$query->execute();
    if ($query) {
        ...
        $_SESSION['alert-class'] = "Student info updated";
    }else{
...
$updated_at = date('F, d y h:i:s');
//SQL query start
$sql="UPDATE `student` SET student_image=:student_image,updated_at=:updated_at WHERE student_id = :id";
$query = $conn->prepare($sql);
$query->bindParam(':student_image',$student_image,PDO::PARAM_STR);
$query->bindParam(':updated_at',$updated_at,PDO::PARAM_STR);
$query->bindParam(':id',$id,PDO::PARAM_STR);
$query->execute();
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 shadow-lg">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="#!">Change password <i class="fa fa fa-server"></i>
                        </a></li>
                    <li>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="subjects" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="layout-sidenav-light.html">Manage Subject
                                    Combination</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="students" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="layout-sidenav-light.html">Manage Students</a>
                                <a class="nav-link" href="layout-sidenav-light.html">ENABLE AND DISABLE
                                    STUDENTS
                                    CHECKING RESULTS.</a>
                            </nav>
                        </div>
                            ...
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4 font-weight-bold">
                                                Update student
                                            </h3>
                                        </div>
                                        <div class="card-body">
...
{    ?>
                                                ...
                                                <div class="form-group" id="imagemi">
                                                    <label>
                                                        ...
                                                        <img class="getpic" src="upload/<?php echo($student_image); ?>"
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="register_no" class="form-control"
                                                            readonly value="<?php echo htmlentities($register_no) ?>"
                                                            placeholder="
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="name" class="form-control" id="name"
                                                            value="<?php echo htmlentities($name) ?>" autocomplete="
                                                            off" placeholder="Student full name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="username" name="username" class="form-control"
                                                            value="<?php echo htmlentities($username) ?>" id="username"
                                                            autocomplete="off" placeholder="Student username">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="email" class="form-control"
                                                            value="<?php echo htmlentities($email) ?>" readonly
                                                            id="email">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="phone_number" name="phone_number"
                                                            ...
                                                            value="<?php echo htmlentities($phone_number) ?>"
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label for="default" class="control-label">How would
                                                            you
                                                            like to
                                                            be
                                                            contacted?</label>
                                                        ...
                                                        <select name="how_would_like_to_be_contacted" id="default"
                                                            ...
                                                            data-style="btn-info">
                                                            <option value="by phone number">By Phone
                                                            </option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="exam_pin" readonly class="form-control"
                                                            value="<?php echo htmlentities($exam_pin) ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" name="card_serial_no" readonly
                                                            class="form-control"
                                                            value="<?php echo htmlentities($card_serial_no) ?>"
                                                            placeholder="
                                                            Card Serial  Number">
