...
$subject = '';   
   ...
   $id = $_GET['edit_id'];
    ...
    $statement = 'SELECT * FROM `add_subject` WHERE `subject_id` =  :id';
...
if(empty($subject)){
   ...
   $_SESSION['alert-class'] = "Field is";
    ...
    $statement = 'UPDATE `add_subject` SET subject = :s_subject,updated_at = :c_updated_at WHERE subject_id = :id';
                                            ...
                                            <form action="edit_subject.php" method="POST">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input class="form-control" name="subject"
                                                        value="<?php echo $subject; ?>" id="subject" type="text"
