...
$sql="INSERT INTO `add_department`(department,created_at)
VALUES(:d_department,:d_created_at)";
$query = $conn->prepare($sql);
$query->bindParam(':d_department',$department,PDO::PARAM_STR);
$query->bindParam(':d_created_at',$created_at,PDO::PARAM_STR);
...
$_SESSION['alert-class'] = "Added department";
                            ...
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4 font-weight-bold">Add
                                                department</h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="add_department.php" method="POST">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit" name="addDepartment"
                                                    ...
                                                    <div class="small"><a class="btn btn-dark"
                                                            href="./manage_department.php">Management</a>
                                                    </div>
                                                </div>
