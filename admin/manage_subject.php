...
$sql="INSERT INTO `add_subject`(subject,created_at)
VALUES(:s_subject,:s_created_at)";
$query = $conn->prepare($sql);
$query->bindParam(':s_subject',$subject,PDO::PARAM_STR);
$query->bindParam(':s_created_at',$created_at,PDO::PARAM_STR);
...
$_SESSION['alert-class'] = "Added subject";
        ...
        <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <div class="row justify-content-center">
                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-2 mb-2">
                                            <div class="small"><a class="btn btn-dark" href="./add_subject.php">Add
                                                    subject</a>
                                            </div>
                            ...
                            $statement = 'SELECT * FROM `add_subject`';
                              ...
                              ?>
                                                    <tr class="text-white font-weight-bold">
                                                        ...
                                                        <td class='btn btn-group'>
                                                            ...
                                                            <?php 
                                            echo "<a href='edit_subject.php?edit_subject&edit_id={$subject_id}' data-toggle='tooltip' data-placement='top' title='Edit'
                                            ...
                                            echo "<a rel='$subject_id' href='javascript:void(0)' data-toggle='tooltip'
                                ...
                                if(isset($_GET['delete'])){
                                    ...
                                    $the_subject_id = $_GET['delete'];
    
                                    $statement = "DELETE FROM `add_subject` WHERE `subject_id` = :id";
            ...
            $(document).ready(function() {
                ...
                $(".delete_link").on('click', function() {
                    ...
                    let deleteUrl = "manage_subject.php?delete=" + id + "";
