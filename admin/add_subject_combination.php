...
$sql="INSERT INTO `add_combination`(class_id,subject_id,status,created_at) VALUES(:class,:cb_subject,:status,:created_at)";
...
$_SESSION['alert-class'] = "Combination subject added";
                            ...
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4 font-weight-bold">Add subject
                                                combination</h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="add_subject_combination.php" method="POST">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit" name="addCombination"
                                                    ...
                                                    <div class="small"><a class="btn btn-dark"
                                                            href="./manage_subjects_combination.php">Management</a>
                                                    </div>
                                                </div>
